...
protected:
	...
	//	UV_THREAD_BIND(CReqUpdateForwardTableMsg::MSG_ID, CReqUpdateForwardTableMsg)
	//	UV_THREAD_BIND(CReqP2PAddrMsg::MSG_ID, CReqP2PAddrMsg)
	//	UV_THREAD_BIND(CReqLogoutMsg::MSG_ID, CReqLogoutMsg)
	//	UV_THREAD_BIND(CReqLeaveRoomMsg::MSG_ID, CReqLeaveRoomMsg)
	//	END_UV_THREAD_BIND(CUDPServer)
